 ...
 * discovery to sessions and orders them by workspace affinity. Candidate
 * requests retain an existing Client Session through completion and wait for
 * its initial history open to succeed before contacting the Host.
 *
